      ...
      <div class="col-sm-8">
        <div class="row wow fadeInRight">
          ...
          <div class="col-lg-7 contenido">
            ...
            <!-- Post data -->
            <p><i class="fa fa-phone" aria-hidden="true"></i>  {{ $exp1->telefono }}<strong>   | </strong><i class="fa fa-envelope-o" aria-hidden="true"> </i><strong></strong> | <i class="fa fa-map-marker" aria-hidden="true"></i> {{ $exp1->direccion }}</p>
